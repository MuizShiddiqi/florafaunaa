        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('dashboard.admin.fauna.create') }}" class="btn btn-primary">Tambah
                        Fauna</a>
                </div>
            </div>
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dashboard.admin.fauna.edit',$product->id) }}"
                                       class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <a href="{{ route('dashboard.admin.fauna.download',$product->id) }}" target="_blank"
...
@section('script')
    <script>
        ...
        $('.btn-delete-fauna').click(function () {
            var id = $(this).data('id');
            $('#form-delete-fauna').attr('action', '{{ route('dashboard.admin.fauna.destroy') }}/' + id)
        })
    </script>
@endsection
