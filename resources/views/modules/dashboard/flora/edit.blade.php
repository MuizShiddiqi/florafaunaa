    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="POST" action="{{ route('dashboard.admin.flora.update',$product->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                <option {{ $product->status == 'Langka' ? 'selected' : '' }}>Langka</option>
                                <option {{ $product->status == 'Dibudidayakan' ? 'selected' : '' }}>Dibudidayakan
                                </option>
