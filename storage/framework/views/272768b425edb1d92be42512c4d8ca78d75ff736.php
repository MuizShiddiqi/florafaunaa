...
<?php $__env->startSection('title','Flora Edit'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Form Edit Flora</h4>
                </div>
                <form method="POST" action="<?php echo e(route('dashboard.admin.flora.update',$product->id)); ?>"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Jumlah</label>
                            <input type="text" class="form-control" name="total" value="<?php echo e($product->total); ?>"
                                   required>
                        </div>
                        <div class="form-group">
                            <label>Status</label>
                            <select class="form-control" name="status">
                                <option <?php echo e($product->status == 'Langka' ? 'selected' : ''); ?>>Langka</option>
                                <option <?php echo e($product->status == 'Dibudidayakan' ? 'selected' : ''); ?>>Dibudidayakan
                                </option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\SEMESTER 7\PPL\florafauna\resources\views/modules/dashboard/flora/edit.blade.php ENDPATH**/ ?>